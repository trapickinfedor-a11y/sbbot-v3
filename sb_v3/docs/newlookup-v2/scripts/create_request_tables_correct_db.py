"""
Create request tables in the correct database (data/newlookup.db)
"""
...
# Override DATABASE_URL to use data/newlookup.db
os.environ['DATABASE_URL'] = 'sqlite+aiosqlite:///./data/newlookup.db'
