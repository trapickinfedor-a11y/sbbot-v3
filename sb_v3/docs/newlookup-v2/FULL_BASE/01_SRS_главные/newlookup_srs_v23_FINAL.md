# Newlookup — Техническое Задание v23.0 (Cursor Edition)

**Версия:** 23.0
**Дата:** 13.03.2026

**Что нового в этой версии:**
- **Cursor-Ready:** Все разделы переписаны с максимальной детализацией для быстрой реализации через Cursor.
- **UI-шаблоны:** Добавлены ASCII/Markdown-шаблоны для всех экранов всех ботов и Admin Panel.
- **Полная CRM:** Создан отдельный документ с полной спецификацией CRM.
- **Готовые классы и роуты:** Созданы документы с готовыми SQLAlchemy-моделями, сервисами, FastAPI-роутами, хендлерами ботов, Celery-задачами и React-компонентами.
- **Финальная схема БД v3:** Обновлена схема БД со всеми новыми таблицами.
